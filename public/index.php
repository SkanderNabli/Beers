...
<header>
    ...
    <!--    <div class="iconBeers">🍺</div>-->
    <div class="iconBeers"><img src="assets/img/AppleBeer.png"></div>
</header>


<div id="app" class="app">

    <section class="background" id="content" data-text="beers ">
    ...
    <div id="modal" class="modal">
        ...
        <div class="modal-img">
            ...
            <h2 class="flexFont">{{ itemShow.name }}</h2>
        </div>
